...
public class BoatInspectionView extends ConstraintLayout {
  ...
  public BoatInspectionView(Context context, AttributeSet attrs) {
    super(context, attrs);
...
//    }
    ...
    inflater.inflate(R.layout.boat_inspection_view, this, true);
...
//    reDraw();
  ...
  public BoatInspectionView(Context context) {
    this(context, null);
  }
