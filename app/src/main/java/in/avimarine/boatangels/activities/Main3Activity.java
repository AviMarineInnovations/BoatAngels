 ...
 */
public class Main3Activity extends AppCompatActivity implements OnFragmentInteractionListener,OnSharedPreferenceChangeListener {
  ...
  private void isUserRegistered(String uid) {
    db.getUser(uid, task -> {
      if (task.isSuccessful()) {
        ...
        if (!document.exists()) {
          Intent intent = new Intent(Main3Activity.this, AddUserActivity.class);
