...
public class SendFeedBackActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    doorbellDialog.setEmail(auth.getCurrentUser().getEmail()); // Prepopulate the email address field
    doorbellDialog.setName(auth.getCurrentUser().getDisplayName()); // Set the name of the user (if known)
    ...
    doorbellDialog
        .setOnFeedbackSentCallback(new io.doorbell.android.callbacks.OnFeedbackSentCallback() {
          ...
          public void handle(String message) {
            ...
            Toast.makeText(getApplicationContext(), "Your feedback was successfully submitted", Toast.LENGTH_LONG).show();
          }
        });
